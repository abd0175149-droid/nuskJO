                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <tr v-for="c in filteredClients" :key="c.id" class="border-t border-gray-100 dark:border-gray-700/50 hover:bg-gray-50 dark:hover:bg-gray-800/30">
                            ...
                            <td class="px-5 py-3 font-bold font-mono" dir="ltr" :class="parseFloat(c.balance_jod)>=0?'text-green-600':'text-red-600'">{{ Math.abs(Number(c.balance_jod)).toLocaleString('en',{minimumFractionDigits:3}) }} JOD</td>
